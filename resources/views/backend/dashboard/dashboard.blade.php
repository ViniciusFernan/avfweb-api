                ...
                <div class="container-xl px-4 mt-n10">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-white border-start-lg border-start-primary text-primary h-100">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="me-3">
                                            <div class="text-xs fw-bold text-uppercase mb-1">Earnings (Monthly)</div>
                                            <div class="text-lg fw-bold text-gray-800">$40,000</div>
                                        </div>
                                        <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                    </div>
                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between small">
                                    <a class="text-black stretched-link" href="#!">View Report</a>
                                    <div class="text-black"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-white border-start-lg border-start-warning text-warning h-100">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="me-3">
                                            <div class="text-xs fw-bold text-uppercase mb-1">Earnings (Annual)</div>
                                            <div class="text-lg fw-bold text-gray-800">$215,000</div>
                                        </div>
                        ...
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-white border-start-lg border-start-success text-success  h-100">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="me-3">
                                            <div class="text-xs fw-bold text-uppercase mb-1">Task Completion</div>
                                            <div class="text-lg fw-bold text-gray-800">24</div>
                                        </div>
                                        <i class="fas fa-clipboard-list fa-2x text-gray-300"></i>
                                    </div>
                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between small">
                                    <a class="text-black stretched-link" href="#!">View Tasks</a>
                                    <div class="text-black"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-white border-start-lg border-start-danger text-danger h-100">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="me-3">
                                            <div class="text-xs fw-bold text-uppercase mb-1">Pending Requests</div>
                                            <div class="text-lg fw-bold text-gray-800">17</div>
                                        </div>
                                        <i class="fas fa-comments fa-2x text-gray-300"></i>
                                    </div>
                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between small">
                                    <a class="text-black stretched-link" href="#!">View Requests</a>
                                    <div class="text-black"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
